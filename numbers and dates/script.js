...
const account1 = {
  ...
  movementsDates: [
    ...
    '2022-02-21T07:42:02.383Z',
    '2022-02-28T09:15:04.904Z',
    '2022-03-02T10:17:24.185Z',
    '2022-03-03T14:11:59.604Z',
...
//Base 10 - 0 to 9. 1/10. 3/10 = 3.33333333
// Binary base 2 - 0 1
console.log(0.1 + 0.2);
...
console.log(2 ** 53 + 3);
console.log(2 ** 53 + 4);
console.log(4411455448411221212225645541511515112n);
console.log(BigInt(4455211212));

// operations
console.log(10000n + 10000n);
console.log(5215453353525354359652525682n * 10000000n);
// console.log(Math.sqrt(16n))

const huge = 8451844514969586295659n;
const num = 23;
...
console.log(new Date(1646756028104));
